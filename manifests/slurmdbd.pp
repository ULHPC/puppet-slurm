...
class slurm::slurmdbd (
  ...
  Optional[String] $purgeeventafter            = undef,
  Optional[String] $purgejobafter              = undef,
  Optional[String] $purgeresvafter             = undef,
  Optional[String] $purgestepafter             = undef,
  Optional[String] $purgesuspendafter          = undef,
  Optional[String] $purgetxnafter              = undef,
  Optional[String] $purgeusageafter            = undef,
  ...
  Optional[String]  $storagecharset     = undef,
  Optional[String]  $storagecollate     = undef,
