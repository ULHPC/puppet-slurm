...
class slurm(
  ...
  Integer[0,default]     $uid                            = $slurm::params::uid,
  Integer[0,default]     $gid                            = $slurm::params::gid,
  ...
  Optional[Stdlib::Fqdn] $maildomain                     = $slurm::params::maildomain,
  ...
  Slurm::ReturnToService $returntoservice                = $slurm::params::returntoservice,
  String                 $statesavelocation              = $slurm::params::statesavelocation,
  Slurm::SchedulerType   $schedulertype                  = $slurm::params::schedulertype,
  Array                  $schedulerparameters            = $slurm::params::schedulerparameters,
  Slurm::SelectType      $selecttype                     = $slurm::params::selecttype,
  Array                  $selecttype_params              = $slurm::params::selecttype_params,
  # Log details
  Slurm::LogLevel        $slurmctlddebug                 = $slurm::params::slurmctlddebug,
  Slurm::LogLevel        $slurmddebug                    = $slurm::params::slurmddebug,
